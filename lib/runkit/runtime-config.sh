...
run.set-next.list() {
  set | ${_bashmatic_grep} '^____run.set.next' | awk 'BEGIN{FS="."}{print $4}' | sedx 's/[() ]//g'
}

run.set-all.list() {
  set | ${_bashmatic_grep} '^____run.set.all' | awk 'BEGIN{FS="."}{print $4}' | sedx 's/[() ]//g'
}
...
____run.set.next.show-command-on() {
  export LibRun__ShowCommand=1
}
____run.set.next.show-command-off() {
  export LibRun__ShowCommand=0
}
...
____run.set.next.abort-on-error() {
  export LibRun__AbortOnError=1
  export LibRun__AskOnError=0
}
____run.set.next.ask-on-error() {
  export LibRun__AskOnError=1
  export LibRun__AbortOnError=0
}
...
____run.set.all.show-output-on() {
  ____run.set.next.show-output-on
  export LibRun__ShowCommandOutput__Default=1
}
...
____run.set.all.show-command-off() {
  ____run.set.next.show-command-off
  export LibRun__ShowCommand__Default=0
}

# Error Handling
____run.set.all.abort-on-error() {
  ____run.set.next.abort-on-error
  export LibRun__AbortOnError__Default=1
  export LibRun__AskOnError__Default=0
}
____run.set.all.ask-on-error() {
  ____run.set.next.ask-on-error
  export LibRun__AskOnError__Default=1
