...
* You can also download the https://raw.githubusercontent.com/kigster/bashmatic/master/README.pdf[PDF version of this document] which is better for print. 

* Additionally please checkout the https://raw.githubusercontent.com/kigster/bashmatic/master/CHANGELOG.md[CHANGELOG] and the https://raw.githubusercontent.com/kigster/bashmatic/master/LICENSE[LICENSE]
====
