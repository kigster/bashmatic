...
Start exploring _Bashmatic®_ below with our <<usage-examples-for-the-impatient,examples section>>. When you are ready, the complete entire set of pubic functions (nearly 500 of those) can be found in the xref:FUNCTIONS.md[functions index page].
