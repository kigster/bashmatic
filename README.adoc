[separator=—]
= HealthSherpa Fork of — Bashmatic® (BASH-based DSL helpers for humans, sysadmins, and fun)
...
|==========================
|             | Badges  
| Lint        | image:https://github.com/healthsherpa/bashmatic/actions/workflows/lint.yml/badge.svg[Lint,link=https://github.com/healthsherpa/bashmatic/actions/workflows/lint.yml]                 
| Bash Tests  | image:https://github.com/healthsherpa/bashmatic/actions/workflows/tests.yml/badge.svg[link="https://github.com/healthsherpa/bashmatic/actions/workflows/tests.yml"]

| Zsh Tests   | image:https://github.com/healthsherpa/bashmatic/actions/workflows/zsh.yml/badge.svg[link="https://github.com/healthsherpa/bashmatic/actions/workflows/zsh.yml"]
