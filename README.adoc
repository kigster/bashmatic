...
image::.dbtop.png[DBTop Example,width=100%,link="https://github.com/kigster/bashmatic/blob/master/FUNCTIONS.adoc#db-top"]
...
image:https://app.fossa.com/api/projects/git%2Bgithub.com%2Fkigster%2Fbashmatic.svg?type=large[License Scan Status,width=400,height=500link=https://app.fossa.com/projects/git%2Bgithub.com%2Fkigster%2Fbashmatic?ref=badge_large]
