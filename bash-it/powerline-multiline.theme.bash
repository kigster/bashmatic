...
# scm python_venv ruby node cwd  |  in_vim clock battery user_info
...
USER_INFO_THEME_PROMPT_COLOR=34
...
PYTHON_VENV_THEME_PROMPT_COLOR=${POWERLINE_PYTHON_VENV_COLOR:=235}
...
HOST_THEME_PROMPT_COLOR=${POWERLINE_HOST_COLOR:=33}
...
unset POWERLINE_LEFT_PROMPT
unset POWERLINE_RIGHT_PROMPT

: "${POWERLINE_LEFT_PROMPT:="hostname scm python_venv ruby node cwd"}"
